...
public class GDTITest {
  ...
  public void testGDTI() throws ValidationException {
    ...
    // Valid GDTI
    assertEquals(
        ConverterUtil.toURI("urn:epc:id:gdti:1234567890.12.ABC"),
        "https://id.gs1.org/253/1234567890128ABC");
    assertEquals(
        ConverterUtil.toURI("urn:epc:id:gdti:124757.578484.!"),
        "https://id.gs1.org/253/1247575784846!");
    assertEquals(
        ConverterUtil.toURI("urn:epc:id:gdti:893489348949..\":?>"),
        "https://id.gs1.org/253/8934893489494\":?>");
    assertEquals(
        ConverterUtil.toURI("urn:epc:id:gdti:434934948984..4"),
    ...
    assertEquals(
        ...
        ConverterUtil.toURN("https://id.gs1.org/253/1234567890123A", 10).get("asURN"));
    assertEquals(
        "urn:epc:id:gdti:1234567890.12.A",
        ConverterUtil.toURN("https://benelog1.de/253/1234567890123A", 10).get("asURN"));
    assertEquals(
        "urn:epc:id:gdti:893489348949..\":?>",
        ConverterUtil.toURN("https://id.gs1.org/253/8934893489494\":?>", 12).get("asURN"));
    assertEquals(
        "urn:epc:id:gdti:434934948984..4",
        ConverterUtil.toURN("https://id.gs1.org/253/43493494898454", 12).get("asURN"));
    assertEquals(
        "urn:epc:id:gdti:124757.578484.!",
        ConverterUtil.toURN("https://id.gs1.org/253/1247575784846!", 6).get("asURN"));
    assertEquals(
        "urn:epc:id:gdti:1849348.39444.8!\"%&\"+",
        ConverterUtil.toURN("https://id.gs1.org/253/18493483944448!\"%&\"+").get("asURN"));
    ...
    assertEquals(
        ...
        ConverterUtil.toURNForClassLevelIdentifier("https://id.gs1.org/253/1234567890123", 10)
            .get("asURN"));
    assertEquals(
        "urn:epc:idpat:gdti:1234567890.12.*",
        ConverterUtil.toURNForClassLevelIdentifier("https://id.gs1.org/253/1234567890123")
            .get("asURN"));
    assertEquals(
        "urn:epc:idpat:gdti:843848923823..*",
        ConverterUtil.toURNForClassLevelIdentifier("https://id.gs1.org/253/8438489238239", 12)
            .get("asURN"));
    ...
    assertEquals(
        ...
        ConverterUtil.toURIForClassLevelIdentifier("urn:epc:idpat:gdti:439483483943..*"));
    assertEquals(
        "https://id.gs1.org/253/4748343847383",
        ConverterUtil.toURIForClassLevelIdentifier("urn:epc:idpat:gdti:474834.384738.*"));
    assertEquals(
        "https://id.gs1.org/253/6374637643768",
        ConverterUtil.toURIForClassLevelIdentifier("urn:epc:idpat:gdti:637463764.376.*"));
    assertEquals(
        "https://id.gs1.org/253/5757834883747",
        ConverterUtil.toURIForClassLevelIdentifier("urn:epc:idpat:gdti:57578348837.4.*"));
  }
}
