...
public class GSRNTest {
  ...
  public void testGSRN() throws ValidationException {
    ...
    assertEquals(
        ...
        "urn:epc:id:gsrn:1234567890.1234567");
    assertEquals(
        converter.toURN("https://hp.com/laptop/8018/301037675245142514").get("asURN"),
        "urn:epc:id:gsrn:301037.67524514251");
    assertEquals(
        converter.toURN("https://hp.com/laptop/8018/302241753828392839").get("asURN"),
        "urn:epc:id:gsrn:302241.75382839283");
    assertEquals(
