...
public class CPITest {
  ...
  public void CPI() throws ValidationException {
    ...
    // Valid CPI
    assertEquals(
        ConverterUtil.toURI("urn:epc:id:cpi:12345-6789.0#1294-5A.4893"),
        "https://id.gs1.org/8010/12345-67890#1294-5A/8011/4893");
    assertEquals(
        ConverterUtil.toURI("urn:epc:id:cpi:123456.789012345.1111"),
        "https://id.gs1.org/8010/123456789012345/8011/1111");
    assertEquals(
        ConverterUtil.toURI("urn:epc:id:cpi:0614141.123ABC.123456789"),
        "https://id.gs1.org/8010/0614141123ABC/8011/123456789");
    assertEquals(
        ConverterUtil.toURI("urn:epc:id:cpi:4748374/23.748#94/.94304"),
    ...
    assertEquals(
        ...
        ConverterUtil.toURN("https://id.gs1.org/8010/12345678A9012/8011/1010", 10).get("asURN"));
    assertEquals(
        "urn:epc:id:cpi:1234567890.12.1010",
        ConverterUtil.toURN("https://id.gs1.org/8010/123456789012/8011/1010", 10).get("asURN"));
    assertEquals(
        "urn:epc:id:cpi:1234567890.12.1010",
        ConverterUtil.toURN("https://benelog.com/8010/123456789012/8011/1010", 10).get("asURN"));
    assertEquals(
        "urn:epc:id:cpi:1234567890.ANC.124",
        ConverterUtil.toURN("https://benelog.com/8010/1234567890ANC/8011/124", 10).get("asURN"));
    assertEquals(
        "urn:epc:id:cpi:4748374/23.748#94/.94304",
        ConverterUtil.toURN("https://id.gs1.org/8010/4748374/23748#94//8011/94304", 10)
            .get("asURN"));
    assertEquals(
        "urn:epc:id:cpi:483948-.67890#1294-5A.4893",
        ConverterUtil.toURN("https://id.gs1.org/8010/483948-67890#1294-5A/8011/4893").get("asURN"));
    ...
    assertEquals(
        ...
        ConverterUtil.toURNForClassLevelIdentifier("https://id.gs1.org/8010/12345678901234", 10)
            .get("asURN"));
    assertEquals(
        "urn:epc:idpat:cpi:1234567890.1234.*",
        ConverterUtil.toURNForClassLevelIdentifier("https://id.gs1.org/8010/12345678901234", 10)
    ...
    assertEquals(
        ...
        ConverterUtil.toURNForClassLevelIdentifier("https://id.gs1.org/8010/123457-57578", 12)
            .get("asURN"));
    assertEquals(
        "urn:epc:idpat:cpi:858588503943.4/38.*",
        ConverterUtil.toURNForClassLevelIdentifier("https://id.gs1.org/8010/8585885039434/38", 12)
            .get("asURN"));
    assertEquals(
        "urn:epc:idpat:cpi:8585885.039434/38.*",
        ConverterUtil.toURNForClassLevelIdentifier("https://id.gs1.org/8010/8585885039434/38")
            .get("asURN"));
    ...
    assertEquals(
        "https://id.gs1.org/8010/12345678901234", ConverterUtil.toURIForClassLevelIdentifier(cpi));

    // Valid class level CPI URN
    assertEquals(
        "https://id.gs1.org/8010/8585885039434/38",
        ConverterUtil.toURIForClassLevelIdentifier("urn:epc:idpat:cpi:858588503943.4/38.*"));
    assertEquals(
        "https://id.gs1.org/8010/43848374387483",
        ConverterUtil.toURIForClassLevelIdentifier("urn:epc:idpat:cpi:438483.74387483.*"));
    assertEquals(
        "https://id.gs1.org/8010/164759476414",
        ConverterUtil.toURIForClassLevelIdentifier("urn:epc:idpat:cpi:164759476414..*"));
    assertEquals(
